...
def test_fk(Slist, Blist, Mlist, M, Ilist, Glist, llist):
...
def test_ik(Slist, Blist, Mlist, M, Ilist, Glist, llist):
...
def test_J(Slist, Blist, Mlist, M, Ilist, Glist, llist):
...
def test_Jinv(Slist, Blist, Mlist, M, Ilist, Glist, llist):
